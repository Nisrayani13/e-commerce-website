  ...
  return (
    <div className="flex w-full h-screen items-center justify-center">
      ...
      <div className="flex w-screen h-screen">
        ...
        >
          <div className={`absolute inset-0 flex flex-col items-center justify-center gap-6 transition-opacity ${hovered[0]?"opacity-100":"opacity-0"}`}>
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-center">
              Discover unique gifts for every occasion. Find the perfect present
              for your loved ones.
            </p>
